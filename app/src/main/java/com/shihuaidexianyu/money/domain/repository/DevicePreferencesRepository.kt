...
interface DevicePreferencesRepository {
    ...
    suspend fun updateHistorySwipeDeleteEnabled(enabled: Boolean)
    suspend fun updateHistorySwipeEditEnabled(enabled: Boolean)
    suspend fun updateAccountSwipeReconcileEnabled(enabled: Boolean)
